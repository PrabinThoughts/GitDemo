...
public class exceptionDemo {
	...
	public static void main(String[] args) {
		...
		finally  //THis block is executed irrespective of exception thrown or not, only when JVM is stopped forcefully during runtime finally block is not execurted. 
		{
